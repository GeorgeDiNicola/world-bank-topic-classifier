...
class TopicClassifier:
    ...
    def find_primary_topic(self, name: str, topic_list: list[str], unique_topics: list[str]) -> str:
        ...
        rich_topic_candidates = [topic_anchors.get(t.strip(), t.strip()) for t in topic_candidates]
        ...
        for original, rich in topic_anchors.items():
